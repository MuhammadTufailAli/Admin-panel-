  ...
  const getData = () => {
    axios
      ...
      .then((res) => {
        ...
        setCurrentUserName(res.data.user.firstname + ' ' + res.data.user.lastname);
      })
      .catch((err) => {
                    ...
                    {getUsersFromBackend.map((data) => (
                      <TableRow
                        ...
                        <TableCell align="center">
                          <img className="Photo" src={data.imageUrl[0]} alt="Avatar" />
                        </TableCell>
                        <TableCell align="center">{data.title}</TableCell>
                        <TableCell align="center"> {data.ratingsAverage}</TableCell>
                        <TableCell align="center">
